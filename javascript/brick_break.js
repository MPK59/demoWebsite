...
Brick_break = {
  ...
  initialize: function(runner, cfg) {
    ...
    this.sound   = false;
    this.court   = Object.construct(Brick_break.Court,  this, cfg.court);
    this.paddle  = Object.construct(Brick_break.Paddle, this, cfg.paddle);
    this.ball    = Object.construct(Brick_break.Ball,   this, cfg.ball);
    this.score   = Object.construct(Brick_break.Score,  this, cfg.score);
  ...
  setLevel: function(level) {
    ...
    level = level < Brick_break.Levels.length ? level : 0;
  ...
  canNextLevel: function()      { return this.is('menu') && (this.level < (Brick_break.Levels.length-1)); },
  ...
  Court: {
    ...
    reset: function(level) {
      var layout = Brick_break.Levels[level];
